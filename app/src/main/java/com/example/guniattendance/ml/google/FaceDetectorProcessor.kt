package com.example.guniattendance.ml.google

import android.content.Context
import android.graphics.Bitmap
import android.util.Log
import com.example.guniattendance.ml.google.support.GraphicOverlay
import com.example.guniattendance.ml.google.support.VisionProcessorBase
...
/** Face Detector Demo.  */
class FaceDetectorProcessor(context: Context, detectorOptions: FaceDetectorOptions?,val callOnSuccess:(List<Face>)->Unit) :
    ...
    fun detectInImage(image: Bitmap): Task<List<Face>> {
